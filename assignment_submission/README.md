...
Production Live Cloud Deployment (Render):

```text
Live App:     https://kaveri-project.onrender.com
Swagger UI:   https://kaveri-project.onrender.com/docs
OpenAPI JSON: https://kaveri-project.onrender.com/openapi.json
```
