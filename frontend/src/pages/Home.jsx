          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center space-y-6 pt-8 animate-fadeInUp">
            ...
            <div className="pt-6 max-w-4xl mx-auto">
              ...
              >
                {/* Destination */}
                <div>
                  <label htmlFor="destination-property" className="block text-[10px] uppercase tracking-wider font-bold text-[#d4af37] mb-1">
                ...
                {/* Check-In */}
                <div>
                  <label htmlFor="hero-checkin-date" className="block text-[10px] uppercase tracking-wider font-bold text-slate-400 mb-1">
                    Check-In Date
                  </label>
                  <input
                    type="date"
                ...
                {/* Check-Out */}
                <div>
                  <label htmlFor="hero-checkout-date" className="block text-[10px] uppercase tracking-wider font-bold text-slate-400 mb-1">
                    Check-Out Date
                  </label>
                  <input
                    type="date"
                ...
                {/* Room Type */}
                <div>
                  <label htmlFor="hero-suite-type" className="block text-[10px] uppercase tracking-wider font-bold text-slate-400 mb-1">
                    Suite Category
                  </label>
                  <select
                    id="hero-suite-type"
                    name="room_type"
                    aria-label="Select Suite Category"
                    value={roomType}
                ...
                <div className="sm:col-span-2 lg:col-span-1 flex items-end">
                  <button
                    type="submit"
                    aria-label="Search Vacancies Across Properties"
              ...
              >
                <div>
                  ...
                  <div className="relative h-64 overflow-hidden">
                    <img
                      ...
                      alt={`${prop.name} luxury resort in ${prop.city}`}
                      width="800"
                      height="500"
                      loading="lazy"
                ...
                <div className="p-6 pt-0 flex gap-2.5">
                  <Link
                    ...
                    aria-label={`Reserve Stay Experience at ${prop.name}`}
                  ...
                  <Link
                    to="/properties"
                    aria-label={`View Property Details for ${prop.name}`}
            ...
            {testimonials.map((t, idx) => (
              ...
              >
                ...
                <div className="pt-3 border-t border-white/10 flex items-center justify-between">
                  <div>
                    <h3 className="font-serif font-bold text-white text-sm">{t.guest}</h3>
